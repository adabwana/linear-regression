...
;* Compared Clojure's native Scicloj machine learning [library](https://github.com/scicloj/scicloj.ml) that leverages Java's Smile machine learning [library](https://haifengl.github.io/) (no alpha parameter, so I used lambda1 and lambda2) against Clojure's implementation of Python's [Scikit Learn](https://scikit-learn.org/stable/) library (does have alpha values I can configure) using sklearn-clj [library](https://github.com/scicloj/sklearn-clj).